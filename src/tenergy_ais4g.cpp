 ...
 * RETURNED:    nothing
 ***********************************************************************/
void tenergy_ais4g::library_version(void)
{
 ...
 * RETURNED:    nothing
 ***********************************************************************/
void tenergy_ais4g::Relay1(bool state)
{
...
/***********************************************************************
 * FUNCTION:    Relay2
 * DESCRIPTION: Control ON-OFF Relay[pin32]
 * PARAMETERS:  0 or 1
 * RETURNED:    nothing
 ***********************************************************************/
void tenergy_ais4g::Relay2(bool state)
{
 ...
 * RETURNED:    nothing
 ***********************************************************************/
void tenergy_ais4g::BuildinLED(bool state)
{
 ...
 * DESCRIPTION: buzzer sound beep[pin04]
 * PARAMETERS:  times
 * RETURNED:    nothing
 ***********************************************************************/
...
/***********************************************************************
 * FUNCTION:    Sw_IO0
 * DESCRIPTION: Read SW_IO0[pin0]
 * PARAMETERS:  nothing
 * RETURNED:    0 or 1
 ***********************************************************************/
bool tenergy_ais4g::Sw_IO0(void)
{
  bool _status = !digitalRead(SW_IO0);
  return _status;
}

/***********************************************************************
 * FUNCTION:    Sw_E18
 * DESCRIPTION: Read SW_E18[pin18]
 * PARAMETERS:  nothing
 * RETURNED:    0 or 1
 ***********************************************************************/
bool tenergy_ais4g::Sw_E18(void)
{
  bool _status = !digitalRead(SW_E18);
  return _status;
}
 ...
 * RETURNED:    0 or 1
 ***********************************************************************/
bool tenergy_ais4g::Slid_sw(void)
{
...
/***********************************************************************
 * FUNCTION:    BuildinLED
 * DESCRIPTION: Blink BuildinLED[pin15]
 * PARAMETERS:  nothing
 * RETURNED:    0 = Off, 1 < blink
 ***********************************************************************/
void tenergy_ais4g::TickBuildinLED(float second)
{
  if (second <= 0)
  {
 ...
 ***********************************************************************/
bool tenergy_ais4g::PWM_Setup(uint8_t channel, double freq, uint8_t resolution_bit, uint8_t pin)
{
 ...
 * RETURNED:    0 = error, 1 = pass
 ***********************************************************************/
bool tenergy_ais4g::PWM_Drive(uint8_t channel, uint8_t percentage)
{
  double _duty = 0;
 ...
 * RETURNED:    minute
 ***********************************************************************/
uint16_t tenergy_ais4g::TimeStamp_minute_encode(uint16_t y, uint8_t m, uint8_t d, uint8_t h, uint8_t mi)
{
 ...
 * RETURNED:    tempstamp
 ***********************************************************************/
uint16_t tenergy_ais4g::TimeStamp_24hr_encode(uint16_t h, uint16_t mi)
{
  return ((h * 60) + mi);
}
 ...
 ***********************************************************************/
void tenergy_ais4g::TimeStamp_hour_minute_decode(uint16_t timestemp, uint16_t &h, uint16_t &mi)
{
  h = timestemp / 60;
  mi = timestemp % 60;
}
 ...
 * RETURNED:    uint16_t
 ***********************************************************************/
uint16_t tenergy_ais4g::crc16_update(uint16_t crc, uint8_t a)
{
  int i;
 ...
 * RETURNED:    uS/cm
 ***********************************************************************/
uint16_t tenergy_ais4g::ec_modbusRTU(uint8_t id)
{
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::ec_modbusRTU_begin(uint8_t rx, uint8_t tx)
{
 ...
 ***********************************************************************/
bool tenergy_ais4g::PZEM_016(uint8_t id, float &volt, float &amp, float &power, uint32_t &energy, float &freq, float &pf)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    power
 ***********************************************************************/
float tenergy_ais4g::PZEM_016_Power(uint8_t id)
{
  float _power;
  // #define modbusRTU_Debug
 ...
 * RETURNED:    energy
 ***********************************************************************/
int16_t tenergy_ais4g::PZEM_016_Energy(uint8_t id)
{
 ...
 * RETURNED:    pf
 ***********************************************************************/
float tenergy_ais4g::PZEM_016_PF(uint8_t id)
{
  float _pf;
 ...
 * RETURNED:    true, false
 ***********************************************************************/
bool tenergy_ais4g::PZEM_016_ResetEnergy(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:   new_id
 ***********************************************************************/
int8_t tenergy_ais4g::PZEM_016_SetAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::PZEM_016_SearchAddress(void)
{
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::PZEM_016_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 ***********************************************************************/
bool tenergy_ais4g::PZEM_003(uint8_t id, float &volt, float &amp, float &power, uint32_t &energy)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    volt
 ***********************************************************************/
float tenergy_ais4g::PZEM_003_Volt(uint8_t id)
{
  float _volt;
  // #define modbusRTU_Debug
 ...
 * RETURNED:    amp
 ***********************************************************************/
float tenergy_ais4g::PZEM_003_Amp(uint8_t id)
{
  float _amp;
  // #define modbusRTU_Debug
 ...
 * RETURNED:    power
 ***********************************************************************/
float tenergy_ais4g::PZEM_003_Power(uint8_t id)
{
  float _power;
  // #define modbusRTU_Debug
 ...
 * RETURNED:    energy
 ***********************************************************************/
int16_t tenergy_ais4g::PZEM_003_Energy(uint8_t id)
{
  uint16_t _energy;
  // #define modbusRTU_Debug
 ...
 * RETURNED:    true, false
 ***********************************************************************/
bool tenergy_ais4g::PZEM_003_ResetEnergy(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:   new_id
 ***********************************************************************/
int8_t tenergy_ais4g::PZEM_003_SetAddress(uint8_t id, uint8_t new_id)
{
...
int8_t tenergy_ais4g::PZEM_003_SearchAddress(void)
{
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::PZEM_003_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::WTR10_E_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 ***********************************************************************/
bool tenergy_ais4g::WTR10_E(uint8_t id, float &temp, float &humi)
{
  // #define modbusRTU_Debug
 ...
 ***********************************************************************/
float tenergy_ais4g::WTR10_E_tempeature(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    _humidity
 ***********************************************************************/
float tenergy_ais4g::WTR10_E_humidity(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::XY_MD02_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
 ...
 * RETURNED:    true, false and reference parameter => temp, humidity
 ***********************************************************************/
bool tenergy_ais4g::XY_MD02(uint8_t id, float &temp, float &humi)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    _temperture
 ***********************************************************************/
float tenergy_ais4g::XY_MD02_tempeature(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    _humidity
 ***********************************************************************/
float tenergy_ais4g::XY_MD02_humidity(uint8_t id)
{
  // #define modbusRTU_Debug
...
int8_t tenergy_ais4g::XY_MD02_searchAddress(void)
{
 ...
 * RETURNED:   new_id
 ***********************************************************************/
int8_t tenergy_ais4g::XY_MD02_SetAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::PR3000_H_N01_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
 ...
 * RETURNED:    true, false and reference parameter => temp, humidity
 ***********************************************************************/
bool tenergy_ais4g::PR3000_H_N01(float &temp, float &humi)
{
 ...
 * RETURNED:    Humidity
 ***********************************************************************/
float tenergy_ais4g::PR3000_H_N01_tempeature()
{
  uint8_t id = 1;
  float _temp, _humi;
  uint16_t _crc = 0xffff;
 ...
 * RETURNED:    humidity
 ***********************************************************************/
float tenergy_ais4g::PR3000_H_N01_humidity()
{
  uint8_t id = 1;
  float _temp, _humi;
  uint16_t _crc = 0xffff;
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::WATER_FLOW_METER_begin(uint8_t rx, uint8_t tx)
{
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::WATER_FLOW_METER_searchAddress(void)
{
  uint8_t _id;
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::WATER_FLOW_METER_SetAddress(uint8_t id, uint8_t new_id)
{
 ...
 ***********************************************************************/
float tenergy_ais4g::WATER_FLOW_METER(uint8_t id)
{
  // #define modbusRTU_Debug
  float _flowrate;
  uint16_t _crc = 0xffff;
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::PYR20_begin(uint8_t rx, uint8_t tx)
{
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::PYR20_searchAddress(void)
{
  uint8_t _id;
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::PYR20_SetAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    W/m^2
 ***********************************************************************/
int16_t tenergy_ais4g::PYR20_read(uint8_t id)
{
  // #define modbusRTU_Debug
...
/***********************************************************************
 * FUNCTION:    ModbusRTU_begin
 * DESCRIPTION: set RX and TX pin
 * PARAMETERS:  rx, tx
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5, float &val6, float &val7, float &val8, float &val9, float &val10)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5, float &val6, float &val7, float &val8, float &val9)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5, float &val6, float &val7, float &val8)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5, float &val6, float &val7)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5, float &val6)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4, float &val5)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3, float &val4)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2, float &val3)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1, float &val2)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
 ...
 ***********************************************************************/
bool tenergy_ais4g::ModbusRTU(uint8_t id, float &val1)
{
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
  uint16_t _crc_r = 0xffff;
...
/***********************************************************************
 * FUNCTION:    ModbusRTU_searchAddress
 * DESCRIPTION: Search Address from ModbusRTU Module [1-253]
 * PARAMETERS:  nothing
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::ModbusRTU_searchAddress(void)
{
  uint8_t _id;
...
/***** Debug monitor ****/
      ...
      if (_crc_r == _crc)
      {
        ...
        Serial.printf("\r\nInfo: the Address of this MobusRTU_client => %d [Success]\r\n", _id);
        return _id;
      }
      else
      {
...
/***** Debug monitor ****/
  ...
  Serial.printf("\r\nInfo: Finish searching .... Can't find MobusRTU_client for this bus [fail]");
}

/***********************************************************************
 * FUNCTION:    ModbusRTU_setAddress
 * DESCRIPTION: Set Address for ModbusRTU Module [1-252]
 * PARAMETERS:  id, new_id
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::ModbusRTU_setAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::ENenergic_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::ENenergic_searchAddress(void)
{
  uint8_t _id;
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::ENenergic_setAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::ENenergic_getTemperature(uint8_t id)
{
  float _floatTemp;
  // #define modbusRTU_Debug
  uint16_t _crc = 0xffff;
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::ENenergic_NeutralCurrent(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::ENenergic_Freq(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::SchneiderPM2xxx_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_AB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_BC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_CA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_LL_Avg(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_AN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_BN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_CN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Voltage_LN_Avg(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_AB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_BC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_CA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_LL_Worst(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_AN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_BN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_CN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_VoltageUnblance_LN_Worst(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentN(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentG(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentAvg(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentUnblanceA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentUnblanceB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentUnblanceC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_CurrentUnblanceWorst(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ActivePowerA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ActivePowerB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ActivePowerC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ActivePowerTotal(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ReactivePowerA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ReactivePowerB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ReactivePowerC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ReactivePowerTotal(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ApparentPowerA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ApparentPowerB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ApparentPowerC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_ApparentPowerTotal(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_PowerFactorA(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_PowerFactorB(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_PowerFactorC(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_PowerFactorTotal(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SchneiderPM2xxx_Freq(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::SDM120CT_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
 ...
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::SDM120CT_searchAddress(void)
{
  uint8_t _id;
...
/***********************************************************************
 * FUNCTION:    SDM120CT_setAddress
 * DESCRIPTION: Set Address for SDM120CT Power Meter [1-247]
 * PARAMETERS:  id, new_id
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::SDM120CT_setAddress(uint8_t id, uint8_t new_id)
{
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_Volt(uint8_t id)
{
  // #define modbusRTU_Debug
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_Current(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
...
/***********************************************************************
 * FUNCTION:    SDM120CT_AP_Power
 * DESCRIPTION: get Apparent power (V/A)
 * PARAMETERS:  address
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_AP_Power(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
...
/***********************************************************************
 * FUNCTION:    SDM120CT_Reac_Power
 * DESCRIPTION: get Reactive power (VAr)
 * PARAMETERS:  address
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_Reac_Power(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_Total_Energy(uint8_t id)
{
  // #define modbusRTU_Debug
  float _tempFloat;
  const byte _byte_len = 9; //จำนวน byte ที่อ่านได้
 ...
 * RETURNED:    float
 ***********************************************************************/
float tenergy_ais4g::SDM120CT_Freq(uint8_t id)
{
  // #define modbusRTU_Debug
...
/***********************************************************************
 * FUNCTION:    WIND_RSFSN01_begin
 * DESCRIPTION: set RX and TX pin
 * PARAMETERS:  rx, tx
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::WIND_RSFSN01_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    rs485.begin(9600, SERIAL_8N1, rx, tx);
...
/***********************************************************************
 * FUNCTION:    WIND_RSFSN01_searchAddress
...
/***********************************************************************
 * FUNCTION:    WIND_RSFSN01_setAddress
 * DESCRIPTION: Set Address for Wind speed sensor [1-247]
 * PARAMETERS:  id, new_id
 * RETURNED:    Address
 ***********************************************************************/
int8_t tenergy_ais4g::WIND_RSFSN01_setAddress(uint8_t id, uint8_t new_id)
{
...
/***********************************************************************
 * FUNCTION:    SIM300CZ_begin
 * DESCRIPTION: set RX and TX pin
 * PARAMETERS:  rx, tx
 * RETURNED:    true/ false
 ***********************************************************************/
bool tenergy_ais4g::SIM300CZ_begin(uint8_t rx, uint8_t tx)
{
  if (((tx == TXD2) || (tx == TXD3)) && ((rx == RXD2) || (rx == RXD3)))
  {
    SIM300CZ.begin(115200, SERIAL_8N1, rx, tx);
    return 1;
  }
  else
  {
    Serial.printf("Error: Fail to define SIM300CZ port!!\r\n");
    return 0;
  }
}

/***********************************************************************
 * FUNCTION:    bool SIM300CZ_cmd
 * DESCRIPTION: Initial SIM300CZ
 * PARAMETERS:  cmd
 * RETURNED:    true/false
 ***********************************************************************/
bool tenergy_ais4g::SIM300CZ_cmd(char *cmd)
{
  ...
  {
    SIM300CZ.write(cmd[i]);
  }

  //   SIM300CZ.println(cmd);

  vTaskDelay(300);

  /**** Read data ****/
  if (SIM300CZ.available())
  {
    ...
    do
    {
      _data_read[_byte_cnt++] = SIM300CZ.read();
      if ((_data_read[0] == 0x00) || (_data_read[0] == 0xFF))
      { // แก้ไช bug เนื่องจากอ่านค่าแรกได้ 0x00 หรือ 0xFF
        _byte_cnt = 0;
      }
      // }while(SIM300CZ.available()>0);
    } while (SIM300CZ.available() > 0 && _byte_cnt < sizeof(_data_read));

    /***** Debug monitor ****/

    // Serial.printf("\r\nData read(%d):  ", _byte_cnt);
    for (byte _i = 0; _i < _byte_cnt; _i++)
    {
      Serial.printf("%c", _data_read[_i]);
    }
  }
...
/***********************************************************************
 * FUNCTION:    bool SIM300CZ_sms
 * DESCRIPTION: send SMS
 * PARAMETERS:  number, sms
 * RETURNED:    true/false
 ***********************************************************************/
bool tenergy_ais4g::SIM300CZ_sms(char *number, char *sms)
{

  Serial.printf("\t\tPhone number => %s\r\n", number);
  Serial.printf("\t\tSMS => %s\r\n", sms);

  uint8_t _data_read[100];
  uint8_t _byte_cnt = 0;

  /**** Write data ****/
  SIM300CZ.flush();
  SIM300CZ.write("AT+CMGS=\"");
  for (int i = 0; i < strlen(number); i++)
  {
    SIM300CZ.write(number[i]);
  }
  SIM300CZ.write("\"");
  vTaskDelay(300);
  SIM300CZ.write(0x0D);
  ...
  if (SIM300CZ.available())
  {
    ...
    /***** Debug monitor ****/
    String _success_sms = "";
    Serial.printf("\t\tInfo: Data read(%d):\r\n", _byte_cnt);
    bool _firttime = true;

    for (byte _i = 0; _i < _byte_cnt; _i++)
    {
      Serial.printf("%c", _data_read[_i]);
      // Serial.printf("\t\t_data_read[%d] = %c\r\n", _i, _data_read[_i]);

      // capture message "OK"
      if (_data_read[_i] == 'O' && _firttime == true)
      {
        _firttime = false;
        int _k = _i;
        for (int _j = 0; _j < 2; _j++)
        {
          _success_sms += char(_data_read[_k++]);
        }
      }
    }
    ...
    if (_success_sms == "OK")
    {
      Serial.printf("\t\tInfo: Sent SMS success\r\n");
      return true;
    }
    else
    {
      Serial.printf("\t\tInfo: Sent SMS fail !!\r\n");
      return false;
    }
  }
